...
const InsertJfrogContainerPushEvent DBStatement = "INSERT INTO jfrogcontainerpush (RegistryURL, RepositoryName, Tag, ImageName, Event, Domain,EventType, Size, SHAID) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)"
